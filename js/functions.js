...
$(document).ready(function () {
    ...
    if ($(window).width() > 991) {
        ...
        aboutTl
            ...
            .from(
                $aboutVisual,
                0.8,
                { x: -50, opacity: 0, ease: Power1.easeOut },
                0
            )
            .from($aboutFrame, 0.8, {
                cssRule: { opacity: 0 },
        ...
        var appDesignScene = new ScrollMagic.Scene({
            ...
            .setTween(
                TweenLite.from($appDesignVisual, 0.8, {
                    x: 100,
                    opacity: 0,
                    ease: Power1.easeOut,
                })
        ...
        var webDesignScene = new ScrollMagic.Scene({
            ...
            .setTween(
                TweenLite.from($webDesignVisual, 0.8, {
                    x: -100,
                    opacity: 0,
                    ease: Power1.easeOut,
                })
    ...
    $(".work__navigation-el").click(function () {
        ...
        $(".work__list")
            .children()
            .eq(position)
            .addClass("work__list-el--is-active");
    });
});
